...
class Goods_detail(models.Model):
    ...
    img_1 = models.ImageField(default="img_upload/001.png", upload_to="img_upload")
    img_2 = models.ImageField(default="img_upload/001.png", upload_to="img_upload")
    img_3 = models.ImageField(default="img_upload/001.png", upload_to="img_upload")
